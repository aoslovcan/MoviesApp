                ...
                <form className="create" onSubmit={this.handleSubmit}>
                    ...
                    <div className="form-group  row">
                        ...
                        <div className="col-sm-6">
                            <input className="form-control " id="title" type="text" value={title} name="title" onChange={this.changeHandler} />
                        </div>
                    ...
                    <div className="form-group row">
                        ...
                        <div className="col-sm-6">
                            <input className="form-control " id="year" type="text" value={year} name="year" onChange={this.changeHandler} />
                        </div>
